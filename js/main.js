...
const window_height = window.innerHeight/1.1;
const window_width = window.innerWidth/1.1;
...
function updateMouseCoordinates(context) {
    ...
    context.fillText(" X: " + Math.floor(mouseX), 25, 10); // Actualiza el texto con la coordenada X
    context.fillText(" Y: " + Math.floor(mouseY), 25, 25); // Actualiza el texto con la coordenada Y
